...
<?php
  ...
  $query_args = array (
    'paged'           => $paged,
    'post_parent'     => get_id_by_slug('acessorios-unica'),
    'post_type'       => 'page',
    'posts_per_page'  => 1,
    'orderby'         => 'menu_order',
    'order'           => 'ASC'
  ...
  <div class="page-container">
    <article class="page__content">
      <div class="info">
        ...
        <!--  <a class="link-modulos <?php // if($paged === 1 or !$paged) { echo "current"; } ?>" href="<?php // echo home_url(); ?>/acessorios-unica/page/1">Tampos &amp; Pia</a>-->
        <!--  | <a class="link-modulos <?php // if($paged === 1) { echo "current"; } ?>" href="<?php // echo home_url(); ?>/acessorios-unica/page/1">Rodapés &amp; Base Invisível</a>-->
        <!--  | <a class="link-modulos <?php // if($paged === 3) { echo "current"; } ?>" href="<?php // echo home_url(); ?>/acessorios-unica/page/3">Nichos Multifunção</a>-->
        <!--</div>-->
      </div>
...
<!-- lightboxes -->
<!--<div id="lb-cores-tampos-unica" class="hidden">-->
<!--  <?php // require_once('cores-tampos-unica.php'); ?>-->
<!--</div>-->
