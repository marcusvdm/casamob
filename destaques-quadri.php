<table class="destaques">
    ...
    <tr>
        ...
        <td>
            <p>Mais de 30 módulos <br>para combinar como quiser</p>
        </td>
    </tr>
    <tr>
        <td class="destaques--img"><img src="<?php bloginfo('template_url'); ?>/assets/images/icons/icon-linha.svg" alt=""></td>
        <td>
            <p>Os armários da LINHA QUADRI CasaMob<br>possuem maior altura que proporcionam<br>melhor área de armazenamento e excelente aproveitamento interno</p>
        </td>
    </tr>
    <!--<tr>-->
