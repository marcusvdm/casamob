    ...
    <article class="page__content">
      ...
      <div class="content">
        ...
        <nav class="menu-linha">
          <a class="menu-linha--item active" href="<?php echo home_url(); ?>/caracteristicas-play">Características</a>
        ...
        ?>
          <div class="txt-content">
            ...
            <ul>
              ...
              <li class="caract-li">Colorido por fora, branco por dentro</li>
              <li class="caract-li">Portas de vidro temperado com esquadria de alumínio</li>
              <li class="caract-li">Rodapé inteligente</li>
              <li class="caract-li">Base Invisível</li>
              <li class="caract-li">4 opções de cores de tampos*</li>
            </ul>
            <p>&nbsp;</p>
