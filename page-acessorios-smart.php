...
<?php
  ...
  $query_args = array (
    'paged'           => $paged,
    'post_parent'     => get_id_by_slug('acessorios-smart'),
    'post_type'       => 'page',
    'posts_per_page'  => 1,
    'orderby'         => 'menu_order',
    'order'           => 'ASC'
      ...
      <div class="info">
        <h2>
          <a href="<?php echo home_url(); ?>#smart">
            ...
            <span class="lt-purple">smart</span>
          </a>
        </h2>
        ...
        <!--  <a class="link-modulos <?php // if($paged === 1 or !$paged) { echo "current"; } ?>" href="<?php // echo home_url(); ?>/acessorios-smart/page/1">Tampos &amp; Pia</a>-->
        <!--  | <a class="link-modulos <?php // if($paged === 1) { echo "current"; } ?>" href="<?php // echo home_url(); ?>/acessorios-smart/page/1">Rodapés &amp; Base Invisível</a>-->
        <!--  | <a class="link-modulos <?php // if($paged === 3) { echo "current"; } ?>" href="<?php // echo home_url(); ?>/acessorios-smart/page/3">Nichos Multifunção</a>-->
        <!--</div>-->
      </div>
...
<!-- lightboxes -->
<!--<div id="lb-cores-tampos-smart" class="hidden">-->
<!--  <?php // require_once('cores-tampos-smart.php'); ?>-->
<!--</div>-->
