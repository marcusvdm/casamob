  ...
  <div class="page-container">
    <article class="page__content">
      <div class="info">
        ...
        <div class="intro">
          <?php the_content();?>
          <small class="legal">Sugestões de modulações CasaMob.
          Não necessariamente disponíveis pra compra no lojista.
          A CasaMob não se responsabiliza pela montagem.</small>
        </div>
      </div>
